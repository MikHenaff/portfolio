...
const ProjectCard = ({ imgSrc, text }) => {
  return (
    <div className="group relative flex flex-col items-center shadow-md p-2">
      <Link
        to={text.toLowerCase()}
        className="absolute top-0 bottom-0 left-0 right-0 opacity-0 group-hover:opacity-100 flex justify-center items-center text-sm sm:text-base text-[#041f1f] underline underline-offset-8 bg-[#18c9c9]/90 w-full h-full border-2 px-3 py-2 rounded-sm"
      >
        Click to see more
      </Link>
      <img
