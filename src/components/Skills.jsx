...
const Skills = () => {
  return (
    ...
    >
      <div className="flex flex-col max-w-[700px] lg:max-w-[900px] xl:max-w-[1000px] 2xl:max-w-[1200px] px-[10%] text-lg md:text-2xl text-[#b8bcbd] mb-10 md:mb-20">
        <h2
          className="self-center md:self-start text-[#18c9c9] text-3xl sm:text-5xl pb-20 sm:pb-[120px] underline underline-offset-4"
          style={{
